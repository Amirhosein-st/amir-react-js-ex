let data = [{"id":1,"firstName":"Tamma","lastName":"Langer","email":"tlanger0@a8.net","gender":"Female","money":"$333.43","country":"Russia"},
...
const franceData = data.filter(person => person.country === "France");

const totalMoney = franceData.reduce((num, curr) => {

  const money = parseFloat(curr.money.replace(/[$,]/g, ''));
  
  return num + money;

}, 0);

const result = totalMoney / franceData.length;
